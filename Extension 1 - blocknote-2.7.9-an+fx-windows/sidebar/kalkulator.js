...
var calculator_checked = 1;

// 25/6/2019


document.getElementById('calculator_check').addEventListener("click", function(){
  
  if(calculator_checked == 1){
        document.getElementById("calculator").removeAttribute("hidden");
        calculator_checked = 0;
  }else{    
        document.getElementById("calculator").setAttribute("hidden","true");
        calculator_checked = 1
  }
});
